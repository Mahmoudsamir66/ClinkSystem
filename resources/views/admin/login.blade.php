...
<div class="login-box">
    ...
    <div class="login-logo ">
        <div class="row">
            <img src="{{asset('public/dist/img/123.jpg')}}" style="height: 200px;width: 200px" class="img-circle elevation-2" alt="Mahmoud Image">
        </div>
        <span class="brand-text-login font-weight-bold">نظام اداره العيادات</span>
    </div>
